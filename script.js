...
LIST_SONG.forEach((song, index) => {
	songs.insertAdjacentHTML('beforeend', `<option value="${index}">${song.name}</option>`)
})
...
previewCode.onchange = function(){
    if(this.value.trim() == 'ngocanhxinhgai') document.querySelector(".countdown-timer").style.display = "none";
    else{
